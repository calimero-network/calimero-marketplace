...
export default function SimpleLogin({ onLogin }: SimpleLoginProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (password === 'test1234') {
      ...
      localStorage.setItem('marketplace_auth', JSON.stringify({
        username,
        authenticated: true,
        timestamp: Date.now()
      }));
      ...
      <div style={{
          ...
          <button
            ...
            onMouseEnter={(e) => {
              if (!loading) {
                ...
                e.currentTarget.style.boxShadow = '0 6px 12px -3px rgba(59, 130, 246, 0.4)';
              }
            }}
            onMouseLeave={(e) => {
        ...
        <div style={{
          ...
          <p style={{
            ...
            Username: any (admin/seller/buyer)<br />
            Password: test1234
          </p>
        </div>
      </div>
