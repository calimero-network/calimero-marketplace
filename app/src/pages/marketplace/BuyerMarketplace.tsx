...
export default function BuyerMarketplace() {
  ...
  const purchaseProduct = async (productId: string, price: string) => {
    try {
      ...
      show({
        title: `Purchase successful! Order ID: ${orderId}. Escrow created for $${price}`,
        variant: 'success',
      });
      await loadData();
    } catch (error) {
      ...
      show({
        title: 'Error purchasing product. See console for details.',
        variant: 'error',
      });
    }
  };
  ...
  const confirmDelivery = async (orderId: string) => {
    try {
      ...
      show({
        title: 'Delivery confirmed! Escrow has been released to the seller.',
        variant: 'success',
      });
      await loadData();
      ...
      show({
        title: 'Error confirming delivery. See console for details.',
        variant: 'error',
      });
    }
  };
            ...
            <>
              ...
              >
                ...
                <p style={{ color: '#666', marginBottom: '16px' }}>
                  When you receive your order, scan the QR code or use the link
                  below to confirm delivery. This will release the escrow
